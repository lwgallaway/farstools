...
#'@notes function will try to continue if it finds any invalid years and will throw a warning
#'@examples
...
#'@notes Function will throw an error if \code{state num} is not a valid state. Function will also see
#'       if there are no accidents for a given state/year and pass a message to that effect. 
#'@importFrom("dplyr","filter")
#'@importFrpm("maps","map")
#'@importFrpm("graphics","points")
#'@examples
